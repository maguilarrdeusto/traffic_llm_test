"""
Django settings for traffic_llm project.
...
SECRET_KEY = 'django-insecure-zv4xrs#ks#=)9&=&djsas!ey+lyy)4-fnbr7#03qc80($x13p1'
SECRET_KEY = os.environ.get('SECRET KEY', default='SECRET_KEY')
